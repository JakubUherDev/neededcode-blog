    ...
    return (
        <div className="container mx-auto px-10 mb-8">
            <div className="border-b w-full inline-block border-blue-400 py-8">
                ...
                <div className="md:float-right block ml-2 w-3/6">
                    <div className="input-group relative flex flex-row items-stretch w-full mb-4">
                        ...
                        <button className="btn ml-1 inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
                ...
                <div className="hidden md:float-left md:contents">
                    {/*{categories.map((category, index) => (*/}
                        <Link href={`/categories`}>
                            <span className="transition duration-500 ease hover:text-pink-300 md:float-right mt-2 align-middle text-white font-semibold cursor-pointer mr-4">
                            Categories
                            </span>
                        </Link>
                    {/*))}*/}
